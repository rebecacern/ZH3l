...
using namespace std;
void datacardmaker8_cut(double mh = 125, int mode = 0){
  ...
  if (mode == 1) sprintf(datacardFile,"%g/zh3l2j_cut_eee_8TeV.txt", mh);
  else if (mode == 2) sprintf(datacardFile,"%g/zh3l2j_cut_eem_8TeV.txt", mh );
  else if (mode == 3) sprintf(datacardFile,"%g/zh3l2j_cut_emm_8TeV.txt", mh );
  else if (mode == 4) sprintf(datacardFile,"%g/zh3l2j_cut_mmm_8TeV.txt", mh);
  else sprintf(datacardFile,"%g/zh3l2j_cut_8TeV.txt", mh);
