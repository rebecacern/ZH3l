...
using namespace std;
void datacardmaker7(double mh = 125, int mode = 0){
  ...
  if (mode == 1) sprintf(datacardFile,"%g/zh3l2j_shape_eee_7TeV.txt", mh);
  else if (mode == 2) sprintf(datacardFile,"%g/zh3l2j_shape_eem_7TeV.txt", mh );
  else if (mode == 3) sprintf(datacardFile,"%g/zh3l2j_shape_emm_7TeV.txt", mh );
  else if (mode == 4) sprintf(datacardFile,"%g/zh3l2j_shape_mmm_7TeV.txt", mh);
  else sprintf(datacardFile,"%g/zh3l2j_shape_7TeV.txt", mh);
