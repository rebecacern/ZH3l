...
using namespace std;
void datacardmaker7_hsm(double mh = 125, int mode = 0){

  const int np = 6;
  TString processName[np] =  { "ZH", "WZ","ZZ","Wjets", "ZH_SM", "Data"};
 
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%g/zh3l2j_input_shape_eee_7TeV.root", mh);
  else if (mode == 2) sprintf(rootFile,"%g/zh3l2j_input_shape_eem_7TeV.root", mh );
  else if (mode == 3) sprintf(rootFile,"%g/zh3l2j_input_shape_emm_7TeV.root", mh );
  else if (mode == 4) sprintf(rootFile,"%g/zh3l2j_input_shape_mmm_7TeV.root", mh);
  else sprintf(rootFile,"%g/zh3l2j_input_shape_7TeV.root", mh);
  ...
  if (mode == 1) sprintf(datacardFile,"%g/zh3l2j_hsm_shape_eee_7TeV.txt", mh);
  else if (mode == 2) sprintf(datacardFile,"%g/zh3l2j_hsm_shape_eem_7TeV.txt", mh );
  else if (mode == 3) sprintf(datacardFile,"%g/zh3l2j_hsm_shape_emm_7TeV.txt", mh );
  else if (mode == 4) sprintf(datacardFile,"%g/zh3l2j_hsm_shape_mmm_7TeV.txt", mh);
  else sprintf(datacardFile,"%g/zh3l2j_hsm_shape_7TeV.txt", mh);
