...
using namespace std;
void datacardmaker8_hsm_cut(double mh = 125, int mode = 0){

  const int np = 7;
  TString processName[np] =  { "ZH", "WZ","ZZ", "VVV", "Wjets", "ZH_SM", "Data"};
 
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%g/zh3l2j_input_cut_eee_8TeV.root", mh);
  else if (mode == 2) sprintf(rootFile,"%g/zh3l2j_input_cut_eem_8TeV.root", mh );
  else if (mode == 3) sprintf(rootFile,"%g/zh3l2j_input_cut_emm_8TeV.root", mh );
  else if (mode == 4) sprintf(rootFile,"%g/zh3l2j_input_cut_mmm_8TeV.root", mh);
  else sprintf(rootFile,"%g/zh3l2j_input_cut_8TeV.root", mh);
  ...
  if (mode == 1) sprintf(datacardFile,"%g/zh3l2j_hsm_cut_eee_8TeV.txt", mh);
  else if (mode == 2) sprintf(datacardFile,"%g/zh3l2j_hsm_cut_eem_8TeV.txt", mh );
  else if (mode == 3) sprintf(datacardFile,"%g/zh3l2j_hsm_cut_emm_8TeV.txt", mh );
  else if (mode == 4) sprintf(datacardFile,"%g/zh3l2j_hsm_cut_mmm_8TeV.txt", mh);
  else sprintf(datacardFile,"%g/zh3l2j_hsm_cut_8TeV.txt", mh);
