...
using namespace std;
void datacardmaker8(double mh = 125, int mode = 0){
  ...
  if (mode == 1) sprintf(datacardFile,"%g/zh3l2j_shape_eee_8TeV.txt", mh);
  else if (mode == 2) sprintf(datacardFile,"%g/zh3l2j_shape_eem_8TeV.txt", mh );
  else if (mode == 3) sprintf(datacardFile,"%g/zh3l2j_shape_emm_8TeV.txt", mh );
  else if (mode == 4) sprintf(datacardFile,"%g/zh3l2j_shape_mmm_8TeV.txt", mh);
  else sprintf(datacardFile,"%g/zh3l2j_shape_8TeV.txt", mh);
